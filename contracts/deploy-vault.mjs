...
async function main() {
  const contractPath = path.resolve(process.cwd(), "contracts/TreasuryVault.sol");
  ...
  console.log("Compiling TreasuryVault...");
  ...
  const contract = output.contracts["TreasuryVault.sol"]["TreasuryVault"];
  ...
  console.log("TreasuryVault deployed to:", deployedAddress);
...
export const TREASURY_VAULT_ADDRESS = '${deployedAddress}' as const;`
  ...
  console.log("Updated constants.ts with TreasuryVault address:", deployedAddress);
}
